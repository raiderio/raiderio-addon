...
-- All rights reserved.
--
local provider={name=...,data=3,region="us",date="2025-09-30T06:04:59Z",numCharacters=87,db={}}
local F
...
F = function() provider.db["Faerlina"]={98,"Bolitrona","Dontchimbo","Guandolo","Hijueputa","Koltarax","Koltaris","Machetiada","Torrm"} end F()
