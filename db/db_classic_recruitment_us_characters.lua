...
-- All rights reserved.
--
local provider={name=...,data=3,region="us",date="2025-09-26T06:05:34Z",numCharacters=112,db={}}
local F
...
F = function() provider.db["Faerlina"]={98,"Bolitrona","Chicoscience","Dontchimbo","Guandolo","Hijueputa","Koltarax","Koltaris","Machetiada","Mgsmiter","Torrm"} end F()
F = function() provider.db["Benediction"]={118,"Grogaldar","Ihuntthebads"} end F()
