...
-- All rights reserved.
--
local provider={name=...,data=1,region="tw",date="2026-03-09T06:37:50Z",currentSeasonId=0,numCharacters=4408,keystoneMilestoneLevels={15,12,10,7,4,2},lookup={},recordSizeInBytes=30,encodingOrder={1,2,5,6,9,10,11,12,14,15}}
local F
