...
-- All rights reserved.
--
local provider={name=...,data=3,region="eu",date="2025-03-15T06:05:37Z",numCharacters=67,db={}}
local F
...
F = function() provider.db["Auberdine"]={18,"Comburstion","Drips","Judgeret","Lumeniros","Opey","Pakololz","Proclacondtm","Switchfords","Ærròr"} end F()
F = function() provider.db["Lakeshire"]={36,"Tâhrox"} end F()
