...
-- All rights reserved.
--
local provider={name=...,data=3,region="eu",date="2025-12-04T06:11:24Z",numCharacters=46,db={}}
local F
...
F = function() provider.db["Norushen"]={72,"Seruss","Tonzil"} end F()
F = function() provider.db["Flamegor"]={76,"Байрамов","Эритропоетин"} end F()
F = function() provider.db["Garalon"]={80,"Mcfat"} end F()
