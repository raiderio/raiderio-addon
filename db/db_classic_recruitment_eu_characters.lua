...
-- All rights reserved.
--
local provider={name=...,data=3,region="eu",date="2025-11-20T06:11:01Z",numCharacters=60,db={}}
local F
...
F = function() provider.db["Hoptallus"]={98,"Arizara","Feronya","Ludidoktor","Nikotako","Psyvise","Rualan"} end F()
F = function() provider.db["Flamegor"]={110,"Синастрия","Тэтцуо"} end F()
