...
L.WARNING_RWF_MODE_ENABLE = "|cffFFFFFF%s|r Race World First Mode is enabled. You may disable it by typing |cffFFFFFF/raiderio rtwf|r."
L.ENABLE_RWF_MODE_BUTTON = "Click to enable Race World First Mode.\r\nThis will cause your Interface to Reload."
L.DISABLE_RWF_MODE_BUTTON = "Click to disable Race World First Mode.\r\nThis will cause your Interface to Reload."
