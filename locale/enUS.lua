...
L.TOOLTIP_PROFILE = "Profile Tooltip Customization"
L.SHOW_RAIDERIO_PROFILE = "Show Profile Tooltip in Dungeon Finder"
L.SHOW_RAIDERIO_PROFILE_DESC = "Show the Raider.IO Profile Tooltip in the Dungeon Finder"
L.SHOW_LEADER_PROFILE = "Allow Profile Tooltip Modifier"
L.SHOW_LEADER_PROFILE_DESC = "Hold down a modifier (shift/ctrl/alt) to toggle Profile Tooltip between Personal/Leader Profile."
L.INVERSE_PROFILE_MODIFIER = "Invert the Profile Tooltip Toggle"
L.INVERSE_PROFILE_MODIFIER_DESC = "Enabling this will invert the behavior of the Profile Tooltip modifier (shift/ctrl/alt): hold to toggle the view between Personal/Leader profile or Leader/Personal profile."
