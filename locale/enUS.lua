...
L.ENABLE_BLIZZARD_SCORE_OVERRIDE = "Show Blizzard Score instead of Raider.IO Score"
L.ENABLE_BLIZZARD_SCORE_OVERRIDE_DESC = "Shows the in-game keystone scores instead of the built-in Raider.IO scores."
...
L.ENABLE_RTWF_MODE_RELOAD = "You are enabling Race To World First Mode. This is intended for use with the Mythic World First race, and should only be used for this purposes only along with the Raider.IO Client for data uploading.\n\n Clicking Confirm will Reload your Interface."
L.DISABLE_RTWF_MODE_RELOAD = "Your are disabling Race To World First Mode.\n\nClicking Confirm will Reload your Interface."
L.WARNING_RTWF_MODE_ENABLE = "|cffFFFFFF%s|r Race To World First Mode is enabled. You may disable it by typing |cffFFFFFF/raiderio rtwf|r."
L.ENABLE_RTWF_MODE_BUTTON = "Click to enable Race To World First Mode.\r\nThis will cause your Interface to Reload."
L.DISABLE_RTWF_MODE_BUTTON = "Click to disable Race To World First Mode.\r\nThis will cause your Interface to Reload."
L.RELOAD_RTWF_MODE_BUTTON = "Click to save the log to storage file.\r\nThis will cause your Interface to Reload."
L.RTWF_FRAME_TITLE = "|cffFFFFFFRaider.IO|r Race To World First"
L.RTWF_FRAME_SUBTITLE_LOGGING_LOOT = "(logging loot)"
L.RTWF_FRAME_SUBTITLE_PAUSED = "(paused)"
